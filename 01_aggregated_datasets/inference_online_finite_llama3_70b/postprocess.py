...
def extract_series(record_metadata:dict, df_nvml_in:pd.DataFrame, df_rapl_in: pd.DataFrame, flag_check=False)->pd.DataFrame:
    ...
    return series, elapsed_seconds, fig, axes, failed
...
def main(output_directory, results_directory):
    ...
    df_results["start_time_exc"] = df_results["start_time_exc"] +pd.Timedelta(10, "seconds")
    df_results["end_time_exc"] = df_results["end_time_exc"] -pd.Timedelta(10, "seconds")
...
if __name__ == "__main__":
    ...
    results_directory = PATH_DATA / "inference_online_finite_llama3_70b"
